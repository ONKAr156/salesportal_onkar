...
const page = ({ params }) => {
    ...
    return <>
        <div className='min-h-screen bg-gray-100 p-4'>
            ...
            {/* <div className='bg-slate-50 shadow-lg h-[10rem] rounded-lg'>
                {
                    admin && admin.map((item) => <div className='flex  justify-between items-center h-full  gap-2' key={item.id}>
                        ...
                        <div className='flex flex-col justify-between gap-1'>
                            ...
                            <div className=''>
                                <span className='md:text-lg font-semibold mx-2'>AdminID:</span>
                            ...
                            <tr key={employee.id}>
                                ...
                                <td className="border px-4 py-2">
                                    <button
                                        ...
                                        className='py-2 px-5 rounded-lg bg-blue-600 text-slate-50'>view</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
